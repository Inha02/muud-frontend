...
const IntroducePage = () => {
  ...
  return (
    <IntroducePageView slickSettings={slickSettings} sliderRef={sliderRef} handleClick={handleClick} currentSlide={currentSlide} moodArray={moodArray}></IntroducePageView>
  )
}
